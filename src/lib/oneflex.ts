...
> = {
  ...
  MAIN_5: {
    label: "Main 5",
    movie:
      "https://vidrock.ru/movie/{id}?theme=22d3ee&autoplay=true&autonext=false&download=false&nextbutton=false",
  ...
  MULTILANGUAGE: {
    ...
    movie: "https://www.viduki.net/2/movie/{id}?color=22d3ee",
    tv: "https://www.viduki.net/2/tv/{id}/{season}/{episode}?color=22d3ee",
  },
  PREMIUM_EMBEDS: {
    label: "Premium",
    movie: "https://www.viduki.net/4/movie/{id}?color=22d3ee",
    tv: "https://www.viduki.net/4/tv/{id}/{season}/{episode}?color=22d3ee",
  },
};
...
export function getOneFlexWatchUrl(movieId: string): string {
  const origin = process.env.ONEFLEX_ORIGIN ?? "https://www.1flex.org";
